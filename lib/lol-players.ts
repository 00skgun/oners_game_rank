...
export const lolPlayers: LolPlayerStat[] = [
  ...
  {team:'ONERS A',position:'원딜',realName:'김규민',nickname:'이이규댓',tag:'댓댓댓',sets:4,kills:38,deaths:9,assists:30,teamKills:118},
  {team:'ONERS A',position:'서폿/미드',realName:'이현우',nickname:'어루대',tag:'KR1',sets:4,kills:12,deaths:10,assists:60,teamKills:118},

  {team:'ONERS B',position:'탑',realName:'김재원',nickname:'나는거장이다',tag:'KR1',sets:5,kills:18,deaths:15,assists:26,teamKills:82},
  {team:'ONERS B',position:'정글',realName:'윤동현',nickname:'Classe',tag:'KR711',sets:5,kills:13,deaths:23,assists:45,teamKills:82},
  {team:'ONERS B',position:'미드',realName:'최건영',nickname:'skgun00',tag:'KR1',sets:5,kills:24,deaths:28,assists:20,teamKills:82},
  {team:'ONERS B',position:'원딜',realName:'박유준',nickname:'보성말차',tag:'KR11',sets:5,kills:26,deaths:22,assists:26,teamKills:82},
  {team:'ONERS B',position:'서폿',realName:'문영서',nickname:'쥬옹두천',tag:'0902',sets:5,kills:1,deaths:22,assists:53,teamKills:82},
